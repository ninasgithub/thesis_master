...
def generate_prompts(diagnosis):
    templates = [
        ...
        "[pronoun] are living with [diagnosis].",
        "[pronoun] have been diagnosed with [diagnosis].",
        "[pronoun] are a [noun] who has been diagnosed with [diagnosis].",
...
if __name__ == "__main__":
    ...
    for model_name in model_names:
        ...
        output_file_neut = f"./{model_name.replace('/', '_')}_NEUT_logits_1110_2.json"
