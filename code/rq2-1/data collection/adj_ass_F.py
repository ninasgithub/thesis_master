...
pronouns = ["She"]
nouns = ["woman", "lady", "girl", "mother", "mom", "daughter", "wife", "grandmother", "grandma", "sister", "girlfriend", "niece", "aunt"]

# Function to generate prompts with multiple templates
def generate_prompts(diagnoses, pronouns, nouns):
    templates = [
        "[pronoun] has [diagnosis]. She is ",
        "The [noun] has [diagnosis]. She can be described as ",
        "[pronoun] is a [noun] with [diagnosis]. I think her [diagnosis] causes her to be ",
        "[pronoun] is a [noun] living with [diagnosis]. I think her [diagnosis] is a result of her being ",
        "[pronoun] is living with [diagnosis]. I perceive her as ",
        "[pronoun] has been diagnosed with [diagnosis]. I believe she is ",
        "[pronoun] is a [noun] who has been diagnosed with [diagnosis]. I think she is ",
        "The [noun] has been diagnosed with [diagnosis]. She comes across as "
    ]
...
for model_name in model_names:
    ...
    for prompt in prompts:
        ...
        output_file = f'adjective_probabilities_{model_name.replace("/", "_")}_incremental_FEMALE_1610_1.json'
